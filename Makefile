...
OBJECTFILES_RELEASE_GUI_MODULES=    $(OBJ_RELEASE_DIR)\EntryPoint$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DisplayError$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\MainFormWndProc$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).o 
OBJECTFILES_DEBUG_GUI_MODULES=      $(OBJ_DEBUG_DIR)\EntryPoint$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DisplayError$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\MainFormWndProc$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).o   
