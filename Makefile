...
OUTPUT_FILE_NAME_GUI=FullScreenWindow$(FILE_SUFFIX_GUI).exe
...
OBJECTFILES_RELEASE_GUI_MODULES=    $(OBJ_RELEASE_DIR)\EntryPoint$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DisplayError$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\GdiMatrix$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\MainFormWndProc$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).o 
OBJECTFILES_DEBUG_GUI_MODULES=      $(OBJ_DEBUG_DIR)\EntryPoint$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DisplayError$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\GdiMatrix$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\MainFormWndProc$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).o   
...
$(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).o: $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).asm
	$(GCC_ASSEMBLER) $(GCC_ASSEMBLER_PARAMETERS_RELEASE) $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).asm -o $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).o

$(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).o:   $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).asm
	$(GCC_ASSEMBLER) $(GCC_ASSEMBLER_PARAMETERS_DEBUG) $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).asm -o $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).o

$(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).asm: $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).c
	$(GCC_COMPILER) $(GCC_COMPILER_PARAMETERS_RELEASE_03) $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).c -o $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).asm

$(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).asm:   $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).c
	$(GCC_COMPILER) $(GCC_COMPILER_PARAMETERS_DEBUG) $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).c -o $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).asm

$(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).c: Modules\DisplaySettingsList.bas Modules\DisplaySettingsList.bi
	$(FREEBASIC_COMPILER) $(FREEBASIC_PARAMETERS_RELEASE_GUI) "Modules\DisplaySettingsList.bas"
	move /y Modules\DisplaySettingsList.c $(OBJ_RELEASE_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).c

$(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).c:   Modules\DisplaySettingsList.bas Modules\DisplaySettingsList.bi
	$(FREEBASIC_COMPILER) $(FREEBASIC_PARAMETERS_DEBUG_GUI) "Modules\DisplaySettingsList.bas"
	move /y Modules\DisplaySettingsList.c $(OBJ_DEBUG_DIR)\DisplaySettingsList$(FILE_SUFFIX_GUI).c



$(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).o: $(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).asm
	$(GCC_ASSEMBLER) $(GCC_ASSEMBLER_PARAMETERS_RELEASE) $(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).asm -o $(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).o

$(OBJ_DEBUG_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).o:   $(OBJ_DEBUG_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).asm
	$(GCC_ASSEMBLER) $(GCC_ASSEMBLER_PARAMETERS_DEBUG) $(OBJ_DEBUG_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).asm -o $(OBJ_DEBUG_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).o

$(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).asm: $(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).c
	$(GCC_COMPILER) $(GCC_COMPILER_PARAMETERS_RELEASE_03) $(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).c -o $(OBJ_RELEASE_DIR)\DisplaySettingsDialogProc$(FILE_SUFFIX_GUI).asm
...
$(OBJ_RELEASE_DIR)\GdiMatrix$(FILE_SUFFIX_GUI).c: Modules\GdiMatrix.bas Modules\GdiMatrix.bi
	$(FREEBASIC_COMPILER) $(FREEBASIC_PARAMETERS_RELEASE_GUI) "Modules\GdiMatrix.bas"
	move /y Modules\GdiMatrix.c $(OBJ_RELEASE_DIR)\GdiMatrix$(FILE_SUFFIX_GUI).c

$(OBJ_DEBUG_DIR)\GdiMatrix$(FILE_SUFFIX_GUI).c:   Modules\GdiMatrix.bas Modules\GdiMatrix.bi
	$(FREEBASIC_COMPILER) $(FREEBASIC_PARAMETERS_DEBUG_GUI) "Modules\GdiMatrix.bas"
	move /y Modules\GdiMatrix.c $(OBJ_DEBUG_DIR)\GdiMatrix$(FILE_SUFFIX_GUI).c
...
$(OBJ_RELEASE_DIR)\Resources$(FILE_SUFFIX_BASE).obj: Resources\Resources.RC Resources\Resources.RH Resources\app.exe.manifest
...
$(OBJ_DEBUG_DIR)\Resources$(FILE_SUFFIX_BASE).obj:   Resources\Resources.RC Resources\Resources.RH Resources\app.exe.manifest
